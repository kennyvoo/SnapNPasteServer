...
class DocScanner(object):
    ...
    def get_contour(self, rescaled_image):
        ...
        if len(test_corners) >= 4:
            ...
            for quad in itertools.combinations(test_corners, 4):
                ...
                points = ImageProcessing.order_points(points)
    ...
    def get_document_corners(self, image):
        ...
        result=[]
        for cnr in screenCnt:
            result.append(round(cnr[0]*ratio,2))
            result.append(round(cnr[1]*ratio,2))
        return result
